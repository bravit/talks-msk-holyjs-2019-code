...
class Tape {
    ...
    fullIdx() {
        return this.idx >= 0 ? {arr: this.right, idx: this.idx}
    ...
    moveLeft() {
        this.idx -= 1;
        if(Math.abs(this.idx + 1) === this.left.length)
            this.left.push(this.blank)
    }
    moveRight() {
        this.idx += 1;
        if(this.idx === this.right.length)
            this.right.push(this.blank)
    }
    moveOn(dx) {
        switch (dx) {
            case MoveEnum.LEFT :
